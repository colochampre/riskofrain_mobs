...
public class WispEntity extends Monster {
  ...
  public static boolean checkWispSpawnRules(EntityType<WispEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
  ...
  public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType type, @Nullable SpawnGroupData data, @Nullable CompoundTag tag) {
    ...
    this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(RoRConfigs.get().MOBS.WISPS.ATTACK_DAMAGE);
    this.getAttribute(Attributes.MAX_HEALTH).setBaseValue(RoRConfigs.get().MOBS.WISPS.MAX_HEALTH);
  ...
  protected @NotNull ResourceLocation getDefaultLootTable() {
    return new ResourceLocation(RoRMod.MOD_ID, "entities/wisp");
  }
  ...
  public boolean removeWhenFarAway(double distance) {
    return RoRConfigs.get().MOBS.WISPS.ENABLE_DESPAWN;
  }
  ...
  protected SoundEvent getAmbientSound() {
    return RoRSounds.WISP_AMBIENT.get();
  }
  ...
  protected SoundEvent getDeathSound() {
    return RoRSounds.WISP_DEATH.get();
  }

  @Override
  protected SoundEvent getHurtSound(DamageSource damageSource) {
    return RoRSounds.WISP_HURT.get();
  }

  protected SoundEvent getLoopSound() {
    return RoRSounds.WISP_LOOP.get();
  }

  protected SoundEvent getSpawnSound() {
    return RoRSounds.WISP_SPAWN.get();
  }
