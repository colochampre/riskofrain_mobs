...
public class GunnerDroneModel<T extends GunnerDroneEntity> extends EntityModel<T> {
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition wing_left = propeller_rod.addOrReplaceChild("wing_left", CubeListBuilder.create().texOffs(1, 5).addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -4.0F, 0.0F, -0.174533F, 0.0F, 0.0F));
    ...
    PartDefinition wing_right = propeller_rod.addOrReplaceChild("wing_right", CubeListBuilder.create().texOffs(15, 5).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -4.0F, 0.0F, 0.174533F, 0.0F, 0.0F));
    ...
    PartDefinition wing_front = propeller_rod.addOrReplaceChild("wing_front", CubeListBuilder.create().texOffs(29, 5).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -0.75F, 0.0F, 0.0F, -0.174533F));
    ...
    PartDefinition wing_back = propeller_rod.addOrReplaceChild("wing_back", CubeListBuilder.create().texOffs(37, 5).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.75F, 0.0F, 0.0F, 0.174533F));
